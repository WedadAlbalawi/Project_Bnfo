...
cd /Users/wedadalbalawi
# remove the channels of it's exists 
...
bwa index /Users/wedadalbalawi/Desktop/project_vcf/ref/Agy99.fasta
...
bwa mem -t 8 ~/Desktop/project_vcf/ref/Agy99.fasta ~/Desktop/project_vcf/data/trimmed_R1.fastq.gz ~/Desktop/project_vcf/data/trimmed_R2.fastq.gz | samtools sort -o ~/Desktop/project_vcf/data/output.sorted.bam -
echo "Alignment and sorted finished running!"

#Step Fifth bcftools mpileup 
#bcftools mpileup -O b -o raw.bcf -f ~/project_vcf/ref/Agy99.fasta --threads 8 -q 20 -Q 30 ~/project_vcf/data/output.sorted.bam 
echo " bcftools mpileup running!"
bcftools call --ploidy 1 -m -v -o ~/Desktop/project_vcf/data/variants.raw.vcf ~/Desktop/project_vcf/data/raw.bcf

#Expplation 
#count the variants
#grep -v -c '^#' variants.raw.vcf 
# count snp  & indels varants
bcftools view -v snps ~/Desktop/project_vcf/data/variants.raw.vcf | grep -v -c '^#' 
bcftools view -v indels  ~/Desktop/project_vcf/data/variants.raw.vcf | grep -v -c '^#' 
bcftools query -f '%POS\n' ~/Desktop/project_vcf/data/variants.raw.vcf >~/Desktop/project_vcf/data/pos.txt